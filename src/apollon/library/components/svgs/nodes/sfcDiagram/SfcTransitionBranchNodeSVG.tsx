import { CustomText } from "@tumaet/apollon/components"
import { LAYOUT } from "@tumaet/apollon/constants"
import { SfcTransitionBranchNodeProps } from "@tumaet/apollon/types"
...
export const SfcTransitionBranchNodeSVG: React.FC<Props> = ({
  ...
  const fillColor = data.fillColor || "var(--apollon-foreground, #000000)"
  return (
    <svg
      width={scaledWidth}
