...
import { CANVAS, EDGES } from "@tumaet/apollon/utils/geometry/routingConstants"
import type { IPoint } from "@tumaet/apollon/edges/Connection"
import { getConnectionMode, getEdgeAnchorPoint } from "@tumaet/apollon/utils/connectionModes"
import { getNodeConnectionRect } from "@tumaet/apollon/utils/geometry/nodeGeometry"
import { type FreeformEdgeAnchor } from "@tumaet/apollon/utils/edgeUtils"
import { routeStepEdge } from "@tumaet/apollon/utils/geometry/edgeRoute"
import { clamp, lexLess } from "@tumaet/apollon/utils/geometry/scalar"
import {
  routeAroundObstaclesBetweenCandidates,
  routeConflictScore,
  type RouteEndpointCandidate,
} from "@tumaet/apollon/utils/geometry/orthogonalRouter"
import type { ObstacleRect } from "@tumaet/apollon/utils/geometry/obstacles"
import {
  ...
  ROUTING_COST,
  weightedRoutingCost,
} from "@tumaet/apollon/utils/geometry/routingCost"
import type { ResolvedEdgeEndpoints } from "@tumaet/apollon/utils/geometry/edgeGeometrySolver"
import {
  OPPOSITE_SIDE,
  OUTWARD_NORMAL,
  SIDE_ORDER,
  ...
  canRunStraight,
  cornerMargin,
} from "@tumaet/apollon/utils/geometry/rectSides"
