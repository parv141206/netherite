# Topic: Internet Protocol v4 (IPv4) [color: green]
...
When an outgoing packet exceeds the egress link Maximum Transmission Unit (typically 1500 bytes for standard Ethernet), the router verifies the Don't Fragment (DF) flag before slicing payload into MTU-compliant segments.
